# -*- coding: utf-8 -*-
"""Wan-xiang 2.7 Video Generation Tool Plugin Entry Point."""
...
class Wan27ToolPlugin:
    """Wan-xiang 2.7 Video Generation Tool Plugin.
    ...
    def register(self, api: PluginApi):
        """Register Wan-xiang 2.7 video tools.
        ...
        api.register_tool(
            ...
            description=(
                "Generate videos from text prompts " "using Wan-xiang 2.7"
            ),
            icon="🎬",
        )
        ...
        api.register_tool(
            ...
            description=("Generate videos from images using Wan-xiang 2.7"),
            icon="🎞️",
        )
        ...
        api.register_tool(
            ...
            description=(
                "Generate videos with character references "
                "using Wan-xiang 2.7"
            ),
            icon="🎭",
        )

        logger.info("Wan-xiang 2.7 tool plugin registered")
