...
REM Usage: install-w-uv.bat [-Version X.Y.Z] [-FromSource] [-SourceDir DIR]
...
echo.
echo Usage: install-w-uv.bat [OPTIONS]
echo.
echo Options:
...
REM ¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T MAIN ¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T¨T
:main
...
echo "%CURRENT_USER_PATH%" | findstr /i /c:"%COPAW_BIN%" >nul 2>&1
if errorlevel 1 (
    if defined CURRENT_USER_PATH (
        powershell -NoProfile -Command "[Environment]::SetEnvironmentVariable('Path', '%COPAW_BIN%;!CURRENT_USER_PATH!', 'User')" >nul
    ) else (
        powershell -NoProfile -Command "[Environment]::SetEnvironmentVariable('Path', '%COPAW_BIN%', 'User')" >nul
    )
    set "PATH=%COPAW_BIN%;!PATH!"
    echo [copaw] Added %COPAW_BIN% to user PATH
) else (
