...
def _update_custom_provider_settings(
...
def _update_builtin_provider_settings(
    provider_id: str,
    data: ProvidersData,
    *,
    api_key: Optional[str],
...
def update_provider_settings(
    ...
    *,
    ...
    if cpd is not None:
        _update_custom_provider_settings(
            cpd,
            api_key=api_key,
            base_url=base_url,
            headers=headers,
        ...
        _update_builtin_provider_settings(
            provider_id,
            data,
            api_key=api_key,
            base_url=base_url,
